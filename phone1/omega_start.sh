...
sleep 8
psql -h 127.0.0.1 -p 5432 -U postgres -d omega_bank   -c "SELECT 1" > /dev/null 2>&1   && echo "  ✅ PostgreSQL bridge ONLINE"   || echo "  ⚠️  PostgreSQL bridge FAILED"
